...
class _AddAddressPageState extends State<AddAddressPage> {
        ...
        child: Column(
          children: [
            ...
            Row(
              ...
              children: [
                addreesName(text: "Home", selected: 0),
                addreesName(text: "Work", selected: 1),
                addreesName(text: "Other", selected: 2),
              ],
            ),
            Gap(16.h),
            ElevatedButton(
              ...
              child: customTextButton(text: "SAVE LOCATION"),
            ),
          ],
        ),
      ),
  ...
  Widget addreesName({required String text, required int selected}) {
    return ChoiceChip(
      label: Text(
        text,
        style: TextStyle(
          fontSize: 13.sp,
          color: isSelected == selected ? AppColors.white : Colors.black,
        ),
      ),
      selected: isSelected == selected,
      onSelected: (_) => setState(() => isSelected = selected),
  ...
  void _saveAddress() {
    ...
    final newAddress = AddressModel(
      ...
      address: "${_addressCtrl.text},  ${_apartmentCtrl.text}",
      icon: icon,
      color: color,
      lat: lat!,
      lng: lng!,
